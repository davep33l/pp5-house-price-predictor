...
def regression_evaluation_plots(X_train,
                                y_train,
                                X_test, y_test,
                                pipeline,
                                alpha_scatter=0.5):
    ...
    sns.scatterplot(x=y_train.squeeze(),
                    y=pred_train.squeeze(),
                    alpha=alpha_scatter,
                    ax=axes[0])
    sns.lineplot(x=y_train.squeeze(),
                 y=y_train.squeeze(),
                 color='purple',
                 ax=axes[0])
    ...
    sns.scatterplot(x=y_test.squeeze(),
                    y=pred_test.squeeze(),
                    alpha=alpha_scatter,
                    ax=axes[1])
    sns.lineplot(x=y_test.squeeze(),
                 y=y_test.squeeze(),
                 color='purple',
                 ax=axes[1])
